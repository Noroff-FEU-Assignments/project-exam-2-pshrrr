...
export default function Home() {
	return (
        ...
        <h3>WE BELIEVE IN CREATIVE WEB SOLUTIONS AND DESIGN. AND
        WE CREATE TAILOR-MADE COOL STUFF FOR PEOPLE AND COMPANIES</h3>
    ...
    <div className="animation">
        <h3>
          We are a newly started company , which will focus solely on the customer and their needs.
        </h3>
    </div>
